...
public class WebRestController {
    ...
    public String hi() {
        ...
        steev.setPhotoURL("http://localhost:8080/authors/King.jpeg");
        ...
        try {
            ClassPathResource backPdfFile = new ClassPathResource("books/pdf-test.pdf");
            byte[] arrayBook = new byte[0];
            arrayBook = new byte[(int) backPdfFile.contentLength()];
            backPdfFile.getInputStream().read(arrayBook);
            book1.setContent(arrayBook);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        book7.setImageURL("http://localhost:8080/1984.jpg");
